...
import { Portfolio } from './../../../../ngx-portfolio/src/public-api';

@Component({
  selector: 'app-sample-portfolio',
  templateUrl: './sample-portfolio.component.html',
  styleUrls: ['./sample-portfolio.component.scss']
})
export class SamplePortfolioComponent implements OnInit {
  ...
  portfolio: Portfolio = {
    ...
    hobbies: [
      { name: 'Cricket', description: "My fixed weekend routine!!", logoImage: '' },
      { name: 'Cooking', description: "I often try to explore healthy options :P", logoImage: '' },
      { name: 'Video Games', description: "I'm way too adictted to games.", logoImage: '' }
    ],
    projects: [
      {
        name: 'Todo List',
